CKEDITOR.plugins.add('spotify', {
    ...
    init: function(editor) {
        ...
        editor.widgets.add('spotify', {
            ...
            allowedContent: 'div[!data-embed-code](!spotify-playlist-wrapper,align-left,align-right,align-center){width,height};' + 
                            'iframe[allow,frameborder,allowtransparency,!width,!height](!no-border)',
            requiredContent:    'div(!spotify-playlist-wrapper);' + 
                                'iframe[allow,frameborder,allowtransparency,!width,!height](!no-border)',
            ...
            upcast: function(element) {
                return element.name === 'div' && element.hasClass('spotify-playlist-wrapper');
            },
...
function parseEmbedCode (embedCode) {
    ...
    var embedURLTemplate = 'https://open.spotify.com/embed/{spotifyType}/{spotifyID}'
